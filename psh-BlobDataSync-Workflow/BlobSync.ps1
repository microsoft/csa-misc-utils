Workflow BlobSync {   
    ...
    $runflag = $TRUE;
    [string]$containerName = 'ContainerToSync'
    $Srcstorageaccountkey = "NotGoingToTell_SrcKey";
    $srcStorageAccount = "SrcStorageAccount";
    $deststorageAccount = "DestStorageAcconut";
    $DestAccountKey = "NotGoingToTell_DestKey";
